...
if (is_category() || is_post_type_archive('blog') || is_singular('blog')) {
...
if (is_post_type_archive('useful') || is_singular('useful') || is_tax('wp_category') || is_page('thanks')) {
	...
	<div class="inner">
		<?php if (is_page()) : ?>
			...
			<?php elseif (is_page('case')) : ?>
				...
				<h1 class="title"><?php the_title(); ?></h1>
			<?php elseif (is_page('sitemap') || is_page('contact') || is_page('contact/thanks') || is_page('privacy-policy')) : ?>
				<h1 class="title"><?php the_title(); ?></h1>
		...
		<?php elseif (is_singular('useful')) : ?>
			<div class="wp">
				<div class="image"><img src="<?php echo esc_url(CFS()->get('material_image')); ?>" alt=""></div>
				<div class="summary">
