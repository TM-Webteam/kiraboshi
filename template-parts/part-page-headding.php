...
if (is_post_type_archive('useful') || is_singular('useful') || is_post_type_archive('wp') || is_singular('wp') || is_tax('wp_category') || is_page('thanks') || is_tax('wp_task')) {
...
?>
	...
	<div class="inner">
		...
		<?php elseif (is_singular('useful') or is_singular('wp')) : ?>
			<div class="wp">
